# Generated by Django 2.2.16 on 2022-03-20 08:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.ForeignKey(help_text='Произведение к которому относится отзыв', on_delete=django.db.models.deletion.CASCADE, related_name='review', to='reviews.Title', verbose_name='Произведение')),
            ],
            options={
                'ordering': ('score',),
            },
